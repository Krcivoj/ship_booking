<div class="rezultat">
      <a href="index.php?rt=ship/show_page&name=<?php echo $reservation->name;?>" target="_blank" style="text-decoration: none;"><img class="brodic" src = ../ship_booking/assets/brod.png></img></a>       
